...
### file%3A%2F%2F%2Fhome%2Fphuonglh%2Fcourses%2Fbda%2Fbankmarketing%2Fbuild.sbt:22: error: ) expected but end of file found
...
lazy val root = (project in file("."))
  .settings(
    ...
    "org.apache.spark" %% "spar k-core" % sparkVersion % "provided",
